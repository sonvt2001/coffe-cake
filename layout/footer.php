...
<footer class="footer">
    <div class="footer-left">
        ...
        <div class="socials">
            <a href="https://www.facebook.com/profile.php?id=100009474123037"><i class="fa fa-facebook"></i></a>
            <a href="https://www.instagram.com/anhtu_18/?fbclid=IwAR3VqqFSk-VboaN7rHvMotyxW30RSRh9cjXIMX-bN2baLkxkdUlDidIBS9I"><i class="fa fa-instagram"></i></a>
    ...
    <ul class="footer-right">
        <li>
            ...
            <ul class="box">
                ...
                <li><a href="http://localhost/coffee-cake/shipper.php">Chính sách giao hàng</a></li>
                <li><a href="http://localhost/coffee-cake/history.php">Sứ mệnh của chúng tôi</a></li>
            </ul>
