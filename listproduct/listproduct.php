                        ...
                        $i = 1;
                            while($row = mysqli_fetch_assoc($query)){?>
                                <tr>
                                    ...
                                    <td>
                                        <a href="editproduct.php?id=<?php echo $row['IDPR']; ?>"style="text-decoration: none;">Sửa</a>
                                    </td>
                                    <td>
                                        <a onclick="return Del('<?php echo $row['NAMEPR']; ?>')" href="deleteproduct.php?id=<?php echo $row['IDPR']; ?>"style="text-decoration: none;">Xóa</a>
                                    </td>
                                </tr>
                            <?php } ?>
                    </tbody>
