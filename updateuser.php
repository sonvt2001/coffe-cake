...
<form id="update-form" method="POST">
    ...
    echo "<input type='text' name='address' placeholder='Điạ chỉ/ Phường/ Quận/ Thành phố hoặc Tỉnh' value='" . $rows['ADDRESS'] . "' required/>";
    ?>
...
if (isset($_POST['update'])){
    ...
    if ($con->connect_error){
        ...
        if (isset($_POST['change-password'])){
            ...
            if($rows > 0){
                $sql1="UPDATE users SET name='$name', email='$email', phone='$phonenumber', address='$address' WHERE username='$username'";
            ...
            $sqli = "UPDATE users SET name='$name', email='$email', phone='$phonenumber', address='$address' WHERE username='$username'";
