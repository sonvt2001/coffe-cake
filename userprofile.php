...
<?php
if($_SESSION['username'] == 'Dangnguyenanhtu'){
    ?>
<div class="list">
    <a class="listprofile" href="http://localhost/coffee-cake/listproduct/listproduct.php">Danh sách sản phẩm</a>
    <a class="listprofile" href="http://localhost/coffee-cake/listbill.php">Danh sách đơn hàng</a>
</div>
<?php
}
?>
